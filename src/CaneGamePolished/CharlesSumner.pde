class CharlesSumner extends Player {
  ...
  public CharlesSumner(int health, int score, int x, int y, int playerNum) {
    super(health, score, x, y,playerNum); //pass in constructor variables to the parent class
  }
  
  @Override //Override annotation; denote the follwoing method overrides the parent class method
  public void playerSetup() {
    super.setImg("CharlesSummer.jpg"); //pass Charles Sumner images into the parent class setter
