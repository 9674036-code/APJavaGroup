...
{
  public LaurenceKeitt(int health, int score, int x, int y, int playerNum) 
  {
    super(health, score, x, y, playerNum);
  }

  @Override
   public void playerSetup() {
    super.setImg("LaurenceKeitt.jpg"); 
    super.playerSetup(); 
  }
  ...
  public void drawPlayer(boolean strike) {
    ...
    if(getAbilityUsed() && getCooldown() <=10){
      ...
      image(super.getImg()[1], super.position()[0]+super.Offsets()[0], super.position()[1]+30);
